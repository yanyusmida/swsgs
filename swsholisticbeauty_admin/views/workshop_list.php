		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="clearfix mtl">
					...
					<a href="<?= config_item('preview_url') ?>" class="btn btn-primary pull-right mll" style="margin-right:10px;">Preview</a>		
					<a href="<?= base_url() ?>psort/<?=$type;?>" class="btn btn-primary pull-right mll" style="margin-right:10px;">Sort</a>	
					<a href="<?= base_url() ?>create/<?=$type;?>" class="btn btn-primary pull-right mll" style="margin-right:10px;">Add</a>		
					<?php	}	?>		
				</div>
					...
					<table class="table table-hover table-striped tablesorter">
						...
						<?php if(count($lists)){ ?>
							...
							<tr>
								...
								<td><?=$li['status'];?></td>
								<td>
									<a href="<?= base_url() ?>slist/<?=$type;?>/<?=$li['id'];?>" class="btn btn-primary pull-left">See List</a>
								</td>
								<td>
									<?php if($this->session->userdata('user_type') == "admin"){	?>
									<a href="<?= base_url() ?>cash/<?=$type;?>/<?=$li['id'];?>" class="btn btn-primary pull-left" style="margin-right:10px;">Add Chash</a>
									<a href="<?= base_url() ?>edit/<?=$type;?>/<?=$li['id'];?>" class="btn btn-primary pull-left" style="margin-right:10px;">Edit</a>
									<a href="<?= base_url() ?>resend/<?=$type;?>/<?=$li['id'];?>" class="btn btn-primary pull-left" style="margin-right:10px;">Resend</a>
									<a href="<?= base_url() ?>ssort/<?=$type;?>/<?=$li['id'];?>" class="btn btn-primary pull-left" style="margin-right:10px;">Sort</a>
									<a href="<?= base_url() ?>report?rpt=workshop&id=<?=$li['id'];?>" class="btn btn-primary pull-left" style="margin-right:10px;">Report</a>
